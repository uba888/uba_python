...
while read domain
do
#	echo "普通页面域名：page.$domain 指向：bjmylike.b0.upaiyun.com dns记录类型：cname记录 "
#	echo "普通页面域名：http://page.$domain 指向：weiduoliya.b0.upaiyun.com dns记录类型：cname记录 "
	echo "个性化域名：personal.$domain 指向114.55.4.124 dns记录类型：a记录"
#	echo " 活动跳转域名：huodong.$domain 指向120.27.146.30  dns记录类型：a记录"
